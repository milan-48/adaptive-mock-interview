...
/** Supported interview types (currently product scope). */
...
export const INTERVIEW_DIFFICULTY_LEVELS = ["easy", "medium", "hard"];
export const DEFAULT_INTERVIEW_DIFFICULTY = "medium";
